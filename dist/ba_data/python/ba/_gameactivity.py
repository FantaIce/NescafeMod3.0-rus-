...
from ba._activity import ColorNotFoundMessage
...
class GameActivity(Activity[PlayerType, TeamType]):
    ...
    def handlemessage(self, msg: Any) -> Any:
        ...
        elif isinstance(msg, ColorNotFoundMessage):
            from ModData.strings import color_not_found_str
            _ba.chatmessage(color_not_found_str)
        else:
